MODULE_NAME = "High Court – Andhra Pradesh (LR_petition_for_respondent_in_WP)"

TEMPLATE_FILE = "LR_petition_for_respondent_in_WP.docx"
...
FIELDS = [
    ...
    ("aff_oath", "Full Details of Deponent"),
